...
import { monitoredLocations, type LocationWithOutbreaks, type ClimateAlert } from "@/lib/ai-utils";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Thermometer, Droplets, AlertTriangle, CloudSun, Wind, MapPin, Plane, Home, Shield, Eye, Activity } from "lucide-react";

const ComprehensiveTravelAdvisory = () => {
        ...
        return (
            <Card className="border-blue-200 shadow-lg shadow-blue-100/30">
                ...
                <CardContent className="p-4 space-y-4">
                    ...
                    {/* Climate Alerts */}
                    {location.climateAlerts && location.climateAlerts.length > 0 && (
                        <div>
...
export default ComprehensiveTravelAdvisory;
